...
const WhatsAppBanner = () => {
  return (
    <>
      <div className="w-full bg-green-900 text-white py-2 px-4 flex items-center justify-center">
        <p className="">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50" fill="white" style={{backgroundColor:'green' , borderRadius:'30%'}}>
